import pytest
from src.customer_analytics.pipeline.text_analysis import TextAnalyzer
from src.customer_analytics.utils.generate_sample import generate_sample_reviews
import pandas as pd
