...
def test_imports():
    ...
    from src.customer_analytics import analysis
    from src.customer_analytics import visualisation
    from src.customer_analytics import pipeline
...
def test_utils_constants():
    ...
    from src.customer_analytics.utils import ROOT, DATA_DIR
...
def test_database_loader_init():
    ...
    from src.customer_analytics.utils import DatabaseLoader
